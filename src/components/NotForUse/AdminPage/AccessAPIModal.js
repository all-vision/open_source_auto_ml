...
export default function SimpleModal(props) {
      ...
      <div className="access-api-modal-wrapper">
        ...
        <div className="code-snippet-wrapper">
          ...
          <div className="code-snippet">
            <TextField
              variant="outlined"
              placeholder={'import requests url = "https://top_label/2010-04-01/Account"'}
              className="api-key-wrapper-textfield"
            />
          </div>
        </div>
        <Button style={{marginTop: '3vh', fontFamily: 'Open Sans, Lato, Roboto', textDecoration: 'none', width:'95%'}} color="primary" variant={'contained'}>
          <a
            href="http://127.0.0.1:8000/docs"
            target="_blank"
            rel="noreferrer"
            style={{color: 'white', textTransform: 'capitalize', textDecoration: 'none', fontSize: '1.1rem'}}
          >
          Access API
          </a>
        </Button>
        <div className="access-api-buttons-wrapper">
          <Button
            ...
            color="default"
            onClick={props.handleCloseAPIAcessModal}
          >
            Close Modal
          </Button>
        </div>
  ...
  return (
    <div>
      <Modal
        open={open}
        onClose={props.handleCloseAPIAcessModal}
